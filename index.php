        ...
        <div class="hero-slide active relative h-[600px] md:h-[700px] bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1200');">
            ...
            <div class="container mx-auto px-4 h-full flex items-center relative z-10">
                <div class="max-w-md text-white">
                    ...
                    <a href="/oecom/shop.php" class="inline-block bg-yellow-50 border border-white px-8 py-3 rounded hover:bg-white hover:text-black transition">
                        Shop Collection
                    </a>
                </div>
            </div>
...
<script src="/oecom/assets/js/lazy-load.js"></script>
