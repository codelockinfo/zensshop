        ...
        <div class="h-full grid grid-cols-1 md:grid-cols-2 bg-white">
            ...
            <div class="p-6 md:p-8 h-full overflow-y-auto custom-scrollbar bg-white relative">
                ...
                <div class="flex gap-4 text-gray-500 mb-6 font-medium">
                    ...
                    <button class="hover:text-black flex items-center gap-1 transition text-xs md:text-sm" onclick="sharePage('${product.name.replace(/'/g, "\\'")}', 'Check out this product!', '${productUrl}')">
                        <i class="fas fa-share-alt"></i> Share
                    </button>
                    <button class="hover:text-black flex items-center gap-1 transition text-xs md:text-sm" onclick="toggleAskQuestionModal(true, '${product.name.replace(/'/g, "\\'")}')">
