...
<section class="py-1  md:py-16" style="background-color: <?php echo htmlspecialchars($section_bg); ?>; color: <?php echo htmlspecialchars($section_text); ?>;">
    <div class="container mx-auto px-4">
        <!-- Render as Grid -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 text-center max-w-full mx-auto">
            <?php foreach ($features as $f): ?>
            <div class="group flex flex-col items-center p-3 md:p-6 rounded shadow-sm h-full transition-transform hover:-translate-y-1 duration-300" 
                ...
                <h3 class="text-lg  md:text-xl font-bold  uppercase tracking-wide" style="color: <?php echo htmlspecialchars($f['heading_color'] ?? $f['text_color']); ?>;">
