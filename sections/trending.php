...
if (file_exists($productsConfigPath)) {
    ...
    $sectionHeading = !empty($conf['tr_heading']) ? $conf['tr_heading'] : $sectionHeading;
    $sectionSubheading = !empty($conf['tr_subheading']) ? $conf['tr_subheading'] : $sectionSubheading;
...
<style>
    ...
    #<?php echo $sectionId; ?> .trending-swiper-prev,
    #<?php echo $sectionId; ?> .trending-swiper-next {
    ...
    #<?php echo $sectionId; ?> .trending-swiper-prev:hover,
    #<?php echo $sectionId; ?> .trending-swiper-next:hover {
        opacity: 0.8;
    }
</style>

<section id="<?php echo $sectionId; ?>" class="pt-5 md:pt-12">
    <div class="container mx-auto px-4">
        ...
        <div class="relative">
            ...
            <?php if (count($products) > 1 && $showTRArrows): ?>
            <button class="absolute left-2 md:-left-5 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full w-10 h-10 flex items-center justify-center text-gray-800 hover:text-[#1a3d32] hover:bg-gray-50 transition z-30 trending-swiper-prev border border-gray-100" aria-label="Previous">
                <i class="fas fa-chevron-left" aria-hidden="true"></i>
            </button>
            <button class="absolute right-2 md:-right-5 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full w-10 h-10 flex items-center justify-center text-gray-800 hover:text-[#1a3d32] hover:bg-gray-50 transition z-30 trending-swiper-next border border-gray-100" aria-label="Next">
