...
<section id="<?php echo $sectionId; ?>" class="pt-8 md:pt-14">
    <div class="container mx-auto px-4">
        <div class="text-center mb-10">
            ...
            <p class="text-sm md:text-lg max-w-2xl mx-auto section-subheading"><?php echo htmlspecialchars($sectionSubheading); ?></p>
        </div>
        ...
        <div class="relative">
            ...
            ?>
                ...
                <button class="absolute left-2 md:-left-4 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full w-10 h-10 flex items-center justify-center text-gray-800 hover:text-[#1a3d32] hover:bg-gray-50 transition z-30 trending-swiper-prev border border-gray-100" aria-label="Previous">
                    <i class="fas fa-chevron-left" aria-hidden="true"></i>
                </button>
                <button class="absolute right-2 md:-right-4 top-1/2 -translate-y-1/2 bg-white shadow-lg rounded-full w-10 h-10 flex items-center justify-center text-gray-800 hover:text-[#1a3d32] hover:bg-gray-50 transition z-30 trending-swiper-next border border-gray-100" aria-label="Next">
