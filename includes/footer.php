...
?>
                ...
                <div class="column w-full md:w-1/2 lg:w-1/3 px-4 mb-8 lg:mb-0">
                    <div class="mb-4">
                        ...
                        if ($logoType === 'image' && !empty($logoImage)) {
                            // Display Logo Image
                            echo '<a href="'.$baseUrl.'"><img src="'.getImageUrl($logoImage).'" alt="'.htmlspecialchars($logoText).'" class="h-15 object-contain"></a>';
                        } else {
                            // Display Logo Text
    ...
    <script src="<?php echo $baseUrl; ?>/assets/js/cart17.js?v=1" defer></script>
    ...
    <script src="<?php echo $baseUrl; ?>/assets/js/quickview16.js?v=2" defer></script>
