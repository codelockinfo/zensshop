    ...
    <script src="<?php echo isset($baseUrl) ? $baseUrl : getBaseUrl(); ?>/assets/js/admin7.js"></script>
    ...
    <script src="<?php echo isset($baseUrl) ? $baseUrl : getBaseUrl(); ?>/assets/js/admin-ajax2.js"></script>
    <?php endif; ?>
    <script>
